      ...
      <div className="space-y-4">
        ...
        <section className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="prose prose-lg prose-slate max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>
              Hi! I am <strong className="text-gray-900 font-serif font-black text-xl">Ding Wang (Chinese name: 王玎).</strong> I am currently an undergraduate student (Class of 2028) majoring in <strong className="text-gray-900 font-serif font-black">Robotics Engineering</strong> at the prestigious <strong className="text-gray-900 font-serif font-black">Li Zexiang Innovation and Entrepreneurship Class</strong>, Teli College, Beijing Institute of Technology. I serve as the monitor of Class 2453.
            </p>
            <p>
              My academic journey is driven by a passion for innovation and excellence. I have maintained the <strong className="text-gray-900 font-serif font-black">top ranking (1st)</strong> in my major comprehensive evaluation. I have been honored as a University-level Excellent Student and College-level Excellent League Member, and have received both First-class and Second-class University Scholarships.
            </p>
            <p>
              In research, I actively lead cutting-edge projects. I serve as the team captain for two National Innovation Projects: <em>"Physics-Informed Reinforcement Learning Algorithms"</em> and <em>"Quantum-Classical Hybrid Algorithms"</em>. My team has achieved significant recognition, winning <strong className="text-amber-600 font-serif font-black">six national-level awards</strong>.
            </p>
            <p>
              Beyond research, I am the leader of the <strong className="text-gray-900 font-serif font-black">Robocon</strong> National University Robotics Competition (Volleyball Track). I possess strong skills in programming, hardware engineering, and project management. I am deeply enthusiastic about Robotics, Embodied AI, and contributing to the open-source community.
            </p>
          ...
          <div className="mt-2 border-t border-gray-100 pt-4">
            ...
            {showChinese && (
              <div className="mt-4 p-4 bg-gray-50 rounded-lg prose prose-sm prose-slate max-w-none text-gray-600">
                ...
                <p>
                  作为队长主持 <strong className="text-gray-900 font-serif font-black">“基于物理信息引导的强化学习算法”</strong> 与 <strong className="text-gray-900 font-serif font-black">“量子-经典混合算法探究”</strong> 两项大创项目，共获得第十九届“挑战杯”全国大学生课外学术科技作品竞赛“人工智能+”挑战赛国家级二等奖、全国大学生数学建模大赛国家级二等奖、CIC “悟空杯” 量子计算大赛(量子创新赛道)国家级一等奖等<strong className="text-amber-600 font-serif font-black">六项国家级奖项</strong>。
                </p>
                <p className="mb-0">
                  目前作为 <strong className="text-gray-900 font-serif font-black">Robocon</strong> 全国大学生机器人大赛排球赛道的负责人，具有较强的编程能力、硬件能力、以及工程项目管理能力。我热衷于机器人技术、具身人工智能以及为开源社区做贡献。
                </p>
              </div>
            )}
          </div>
